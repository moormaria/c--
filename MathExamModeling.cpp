...
const string name[10] = { "Moor Maria", "Goleva Kristina", "Sitnikova Maria", "Zhuchenko Anna", "Shabanova Arina", "Zaydiev Artur", "Egorkin Stanislav", "Naumovich Lavertniy", "Jeon Jungkook", "Pirozhkov Artur" };
